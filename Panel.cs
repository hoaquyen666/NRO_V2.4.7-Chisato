...
public class Panel : IActionListener, IChatable
{
	...
	public int keyTouchTab = -1;

	public int nTableItem;
	...
	public bool isKiguiXu;

    public bool isKiguiLuong;
    ...
    public void paintTools(mGraphics g)
	{
		g.setClip(xScroll, yScroll, wScroll, hScroll);
		g.translate(0, -cmy);
	...
	private void paintInventory(mGraphics g)
	{
		...
		if (flag && isnewInventory)
		{
			...
			if (newSelected == 0)
			{
				...
				Char.myCharz().paintCharBody(g, num6 + 34 + 17, num7 + num9 - 25, 1, 0, true);
				num3 = 3;
				num15 = 2;
				num6 = xScroll + 34;
