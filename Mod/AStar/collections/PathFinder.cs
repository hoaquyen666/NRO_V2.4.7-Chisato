using Assets.Scripts.Assembly_CSharp.Mod.AStar.Collections.PathFinder;
using Assets.Scripts.Assembly_CSharp.Mod.AStar.Heuristics;
...
namespace Assets.Scripts.Assembly_CSharp.Mod.AStar.collections
{
    public class PathFinder : IFindAPath
    {
        ...
        private int CalculateModifierToG(PathFinderNode q, PathFinderNode successor, Position end)
        {
            ...
            var gPunishment = System.Math.Abs(successor.Position.Row - end.Row) + System.Math.Abs(successor.Position.Column - end.Column);
