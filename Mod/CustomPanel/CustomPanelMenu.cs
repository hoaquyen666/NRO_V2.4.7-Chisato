using Assets.Scripts.Assembly_CSharp.Mod.ModMenu;
using System;
...
namespace Assets.Scripts.Assembly_CSharp.Mod.CustomPanel
{
    internal class CustomPanelMenu
    {
        ...
        internal void SetType()
        {
            ...
            {
                panel.mainTabName = panel.tabName[TYPE_CUSTOM_PANEL_MENU] = modMenuPanelTabName;
                panel.currentTabName = panel.tabName[TYPE_CUSTOM_PANEL_MENU];
                panel.currentTabIndex = Mathf.Clamp(panel.currentTabIndex, 0, modMenuPanelTabName.Length - 1);
        ...
        internal static void PaintTopInfo(Panel panel, mGraphics g)
        {
            ...
            Image avtMiyo = GameCanvas.loadImage("/mainImage/avtMiyo.png");
            g.drawImage(avtMiyo, panel.X + 25, 50, 33);
            //SmallImage.drawSmallImage(g, avtMiyo, panel.X + 25, 50, 0, 33);
            mFont.tahoma_7b_white.drawString(g, "", panel.X + 60, 4, mFont.LEFT, mFont.tahoma_7b_dark);
            mFont.tahoma_7_yellow.drawString(g, "" + ": v" + GameMidlet.VERSION, panel.X + 60, 16, mFont.LEFT, mFont.tahoma_7_grey);
